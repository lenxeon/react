	  ...
	  _createClass(TaskDetail, [{
	    ...
	    value: function render() {
	      ...
	      return _react2['default'].createElement(
	        _PushLeft2['default'],
	        { open: true, className: 'task-detail-side' },
	        _react2['default'].createElement(
	          'div',
	          null,
	          _react2['default'].createElement(
	            'div',
	            { className: 'top-bar clear' },
	            _react2['default'].createElement(
	              'span',
	              { className: 'lft' },
	            ...
	            _react2['default'].createElement(
	              ...
	              _react2['default'].createElement('i', { className: 'fa fa-tags ml-15' }),
	              _react2['default'].createElement('i', { className: 'fa fa-files-o ml-15' }),
	              _react2['default'].createElement('i', { className: 'fa fa-link ml-15' }),
	              _react2['default'].createElement('i', { className: 'fa fa-chevron-down ml-15' })
	            )
	          ),
	          _react2['default'].createElement(
	            'div',
	            { className: 'title-box clear' },
	            _react2['default'].createElement(
	              'ul',
	              null,
	              _react2['default'].createElement(
	                'li',
	                { className: 'clear' },
	                _react2['default'].createElement('i', { className: 'fa fa-archive lft' }),
	                _react2['default'].createElement(
	                  'span',
	                  { className: 'ml-10 lft' },
	                  '未关联项目'
	                ),
	                _react2['default'].createElement('i', { className: 'fa fa-pencil rgt' }),
	                _react2['default'].createElement('i', { className: 'fa mr-10 fa-times rgt' })
	              ),
	              _react2['default'].createElement(
	                'li',
	                { className: 'clear' },
	                _react2['default'].createElement('i', { className: 'fa fa-list lft' }),
	                _react2['default'].createElement(
	                  'span',
	                  { className: 'ml-10 lft' },
	                  '我负责的任务'
